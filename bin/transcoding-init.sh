...
do
	case $ANSWER in
		Yes )
			...
			echo "cat \$WORKER_LOG_FILE | tr '\r' ' ' | grep '^frame=' | rev | tr -s ' ' | cut -f '9' -d ' ' | rev" >> "profiles/h264-main-3-1.currentFrame"
			...
			echo "cat \$WORKER_LOG_FILE | tr '\r' ' ' | grep '^frame=' | rev | tr -s ' ' | cut -f '9' -d ' ' | rev" >> "profiles/h264-main-4-0.currentFrame"
			...
			echo "cat \$WORKER_LOG_FILE | tr '\r' ' ' | grep '^frame=' | rev | tr -s ' ' | cut -f '9' -d ' ' | rev" >> "profiles/h264-high-4-0.currentFrame"
			...
			echo "cat \$WORKER_LOG_FILE | tr '\r' ' ' | grep '^frame=' | rev | tr -s ' ' | cut -f '9' -d ' ' | rev" >> "profiles/h264-high-4-1.currentFrame"
			...
			echo "cat \$WORKER_LOG_FILE | tr '\r' ' ' | grep '^frame=' | rev | tr -s ' ' | cut -f '9' -d ' ' | rev" >> "profiles/hls-h264-baseline-3-0.currentFrame"
			chmod +x profiles/*
			break;;
		No )
			mkdir profiles
